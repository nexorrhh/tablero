...
const SECTIONS = [
  ...
  { id:'rrhh',        label:'Recursos Humanos', icon:'users',   group:'Personas',     tabs:['Panel','Plantel','Permisos y solicitudes','Sábados y feriados','Postulantes y candidatos','Vencimientos'] },
